...
<html>
    ...
    <body>
        <header>
            ...
            <div class="textos">
                <h1>VideoJuegos</h1>
                <h2>Bienvenido al área de videojuegos, Interactúa sobre tus videojuegos favoritos</h2>
            </div>
        </header>
        <br>
        ...
        <div class="container">
            ...
            <?php
            $sql = "SELECT h.id_hilo, u.nombre_usuario,h.titulo,h.texto,h.fecha FROM hilo h INNER JOIN usuario u ON h.creador=u.id_usuario WHERE h.categoria=1" ;
            ...
            while ($mostrar = mysqli_fetch_array($resultado)) {
                ...
                <div class="container" >
                    ...
                    <div class=" list-group-item list-group-item-dark">
                        ...
                        <a href='ResponderVideojuegos.php?id=<?php echo $mostrar['id_hilo'] ?>' class="btn btn-success float-right">Responder </a>
                        <br>
                        <br>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function () {
                $("#btnResponderFJ").on('click', function () {
                    $("#responderHiloFJ").show();
                    return false;
                });
            });
        </script>
