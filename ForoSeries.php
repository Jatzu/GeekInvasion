...
<html>
    ...
    <body>
        <header>
            ...
            <div class="textos">
                <h1>Series</h1>
                <h2>Bienvenido al área de Series</h2>
            </div>
        </header>
        <br>
        ...
        <div class="container">
            ...
            <?php
            $sql = "SELECT h.id_hilo, u.nombre_usuario,h.titulo,h.texto,h.fecha FROM hilo h INNER JOIN usuario u ON h.creador=u.id_usuario WHERE h.categoria=2";
            ...
            while ($mostrar = mysqli_fetch_array($resultado)) {
                ...
                <div class="container" >
                    ...
                    <div class=" list-group-item list-group-item-dark">
                        ...
                        <a href='ResponderSeries.php?id=<?php echo $mostrar['id_hilo'] ?>' class="btn btn-success float-right">Responder </a>
                        <br>
                        <br>
                    </div>
                </div>
